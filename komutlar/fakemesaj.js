...
exports.run = function (client, message, args) {
    ...
    if (message.mentions.users.size < 1) return message.reply('Lütfen Birini Etiketle')
    let yazi = args[1]
    if (!yazi) return message.reply('Sana Zahmet Bir De Göndereceği Mesajı Yazıver')
    message.delete()
